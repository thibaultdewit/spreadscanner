...
describe('ExchangeWrapper', function () {
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    zeroEx = new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, config);
            ...
            describe('negative fill amount', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    it('should not allow the exchange wrapper to fill if amount is negative', function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, expect(zeroEx.exchange.fillOrderAsync(signedOrder, negativeFillTakerAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)).to.be.rejected()];
                        });
                    }); });
                    return [2 /*return*/];
                });
            ...
            describe('negative batch fill amount', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    it('should not allow the exchange wrapper to batch fill if any amount is negative', function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, expect(zeroEx.exchange.batchFillOrdersAsync(orderFillBatch, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)).to.be.rejected()];
                        });
                    }); });
                    return [2 /*return*/];
                });
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, zeroEx.token.transferAsync(makerTokenAddress, makerAddress, coinbase, missingBalance)];
                            case 1:
                                // but won't have 10 to fully fill all orders in a batch.
                                _a.sent();
                                return [4 /*yield*/, zeroEx.exchange.fillOrdersUpToAsync(signedOrders, fillUpToAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)];
                            case 2:
                                txHash = _a.sent();
                                return [4 /*yield*/, zeroEx.awaitTransactionMinedAsync(txHash)];
                            case 3:
                ...
                it("should fail validation if user doesn't have enough balance without fill up to", function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                return [2 /*return*/, expect(zeroEx.exchange.fillOrdersUpToAsync(signedOrders, fillUpToAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)).to.be.rejectedWith(src_1.ExchangeContractErrs.InsufficientMakerBalance)];
                        }
                    });
                }); });
            });
