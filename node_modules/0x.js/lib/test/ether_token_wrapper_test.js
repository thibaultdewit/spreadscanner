...
describe('EtherTokenWrapper', function () {
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    zeroEx = new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, zeroExConfig);
                ...
                case 2:
                    ...
                    wethContractAddress = zeroEx.etherToken.getContractAddressIfExists();
                    depositWeiAmount = zeroEx._web3Wrapper.toWei(new utils_1.BigNumber(5));
                    decimalPlaces = 7;
    ...
    describe('#getContractAddressIfExists', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            it('should return contract address if connected to a known network', function () {
                var contractAddressIfExists = zeroEx.etherToken.getContractAddressIfExists();
            ...
            it('should throw if connected to a private network and contract addresses are not specified', function () {
                ...
                expect(function () {
                    return new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, zeroEx.etherToken.depositAsync(wethContractAddress, depositWeiAmount, addressWithETH)];
                    case 3:
                        txHash = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, expect(zeroEx.etherToken.depositAsync(wethContractAddress, overETHBalanceinWei, addressWithETH)).to.be.rejectedWith(src_1.ZeroExError.InsufficientEthBalanceForDeposit)];
                }
            });
        }); });
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, zeroEx.etherToken.withdrawAsync(wethContractAddress, depositWeiAmount, addressWithETH)];
                    case 5:
                        txHash = _a.sent();
                        return [4 /*yield*/, zeroEx.awaitTransactionMinedAsync(txHash)];
                    case 6:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, expect(zeroEx.etherToken.withdrawAsync(wethContractAddress, overWETHBalance, addressWithETH)).to.be.rejectedWith(src_1.ZeroExError.InsufficientWEthBalanceForWithdrawal)];
                }
            });
        }); });
    });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, zeroEx.etherToken.depositAsync(etherTokenAddress, transferAmount, addressWithETH)];
                        case 1:
                            _a.sent();
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Transfer, indexFilterValues, callback);
                            return [4 /*yield*/, zeroEx.token.transferAsync(etherTokenAddress, addressWithETH, addressWithoutFunds, transferAmount)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Approval, indexFilterValues, callback);
                            return [4 /*yield*/, zeroEx.token.setAllowanceAsync(etherTokenAddress, addressWithETH, addressWithoutFunds, allowanceAmount)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Deposit, indexFilterValues, callback);
                            return [4 /*yield*/, zeroEx.etherToken.depositAsync(etherTokenAddress, depositAmount, addressWithETH)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Withdrawal, indexFilterValues, callback);
                            return [4 /*yield*/, zeroEx.etherToken.withdrawAsync(etherTokenAddress, withdrawalAmount, addressWithETH)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Transfer, indexFilterValues, callbackNeverToBeCalled);
                            callbackToBeCalled = report_callback_errors_1.reportNodeCallbackErrors(done)();
                            newProvider = dev_utils_1.web3Factory.getRpcProvider();
                            zeroEx.setProvider(newProvider, constants_1.constants.TESTRPC_NETWORK_ID);
                            return [4 /*yield*/, zeroEx.etherToken.depositAsync(etherTokenAddress, transferAmount, addressWithETH)];
                        case 1:
                            _a.sent();
                            zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Transfer, indexFilterValues, callbackToBeCalled);
                            return [4 /*yield*/, zeroEx.token.transferAsync(etherTokenAddress, addressWithETH, addressWithoutFunds, transferAmount)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            subscriptionToken = zeroEx.etherToken.subscribe(etherTokenAddress, src_1.EtherTokenEvents.Transfer, indexFilterValues, callbackNeverToBeCalled);
    ...
    describe('#getLogsAsync', function () {
        ...
        it('should get logs with decoded args emitted by Approval', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, zeroEx.token.setUnlimitedProxyAllowanceAsync(etherTokenAddress, addressWithETH)];
                    case 1:
                        txHash = _a.sent();
                        return [4 /*yield*/, zeroEx.awaitTransactionMinedAsync(txHash)];
                    case 2:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.etherToken.getLogsAsync(etherTokenAddress, eventName, blockRange, indexFilterValues)];
                    case 3:
                        logs = _a.sent();
        ...
        it('should get logs with decoded args emitted by Deposit', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, zeroEx.etherToken.depositAsync(etherTokenAddress, depositAmount, addressWithETH)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.etherToken.getLogsAsync(etherTokenAddress, differentEventName, blockRange, indexFilterValues)];
                    case 3:
                        logs = _a.sent();
        ...
        it('should only get the logs with the correct indexed fields', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, zeroEx.token.setUnlimitedProxyAllowanceAsync(etherTokenAddress, addressWithoutFunds)];
                    case 3:
                        txHash = _a.sent();
                        return [4 /*yield*/, zeroEx.awaitTransactionMinedAsync(txHash)];
                    case 4:
