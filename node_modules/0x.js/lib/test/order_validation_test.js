    ...
    describe('validateCancelOrderAndThrowIfInvalidAsync', function () {
        ...
        it('should throw when cancel amount is zero', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, expect(zeroEx.exchange.validateCancelOrderThrowIfInvalidAsync(signedOrder, zeroCancelAmount)).to.be.rejectedWith(src_1.ExchangeContractErrs.OrderCancelAmountZero)];
            });
        }); });
        it('should throw when order is expired', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, expect(zeroEx.exchange.validateCancelOrderThrowIfInvalidAsync(expiredSignedOrder, cancelAmount)).to.be.rejectedWith(src_1.ExchangeContractErrs.OrderCancelExpired)];
                }
            });
        }); });
        it('should throw when order is already cancelled or filled', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, expect(zeroEx.exchange.validateCancelOrderThrowIfInvalidAsync(signedOrder, fillableAmount)).to.be.rejectedWith(src_1.ExchangeContractErrs.OrderAlreadyCancelledOrFilled)];
                }
            });
        }); });
    });
