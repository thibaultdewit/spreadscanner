...
describe('ZeroEx library', function () {
    ...
    var zeroEx = new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, config);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, zeroEx.signOrderHashAsync(orderHash, makerAddress, SHOULD_ADD_PERSONAL_MESSAGE_PREFIX)];
                    case 1:
                        ecSignature = _a.sent();
    ...
    describe('#config', function () {
        it('allows to specify exchange contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                zeroExWithWrongExchangeAddress = new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, zeroExConfig);
        ...
        it('allows to specify token registry token contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                zeroExWithWrongTokenRegistryAddress = new src_1.ZeroEx(web3_wrapper_1.web3.currentProvider, zeroExConfig);
