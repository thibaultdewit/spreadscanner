...
describe('EventWatcher', function () {
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            web3 = dev_utils_1.web3Factory.create();
    ...
    it('correctly emits initial log events', function (done) {
        ...
        var expectedToBeCalledOnce = false;
        var callback = report_callback_errors_1.reportNodeCallbackErrors(done, expectedToBeCalledOnce)(function (event) {
