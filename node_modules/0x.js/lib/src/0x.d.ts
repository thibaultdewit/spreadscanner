...
import { Web3Provider, ZeroExConfig } from './types';
/**
...
export declare class ZeroEx {
     ...
     */
    signOrderHashAsync(orderHash: string, signerAddress: string, shouldAddPersonalMessagePrefix: boolean): Promise<ECSignature>;
    /**
