...
var zero_ex_private_network_config_schema_1 = require("./schemas/zero_ex_private_network_config_schema");
var zero_ex_public_network_config_schema_1 = require("./schemas/zero_ex_public_network_config_schema");
...
var ZeroEx = /** @class */ (function () {
    ...
    function ZeroEx(provider, config) {
        ...
        assert_1.assert.doesConformToSchema('config', config, zero_ex_config_schema_1.zeroExConfigSchema, [
            zero_ex_private_network_config_schema_1.zeroExPrivateNetworkConfigSchema,
            zero_ex_public_network_config_schema_1.zeroExPublicNetworkConfigSchema,
        ]);
    ...
    ZeroEx.isValidSignature = function (data, signature, signerAddress) {
        ...
        var isValidSignature = signature_utils_1.signatureUtils.isValidSignature(data, signature, normalizedSignerAddress);
    ...
    ZeroEx.prototype.signOrderHashAsync = function (orderHash, signerAddress, shouldAddPersonalMessagePrefix) {
        return __awaiter(this, void 0, void 0, function () {
            var normalizedSignerAddress, msgHashHex, orderHashBuff, msgHashBuff, signature, validVParamValues, ecSignatureVRS, isValidVRSSignature, ecSignatureRSV, isValidRSVSignature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._web3Wrapper.signTransactionAsync(normalizedSignerAddress, msgHashHex)];
                    case 2:
                        signature = _a.sent();
                        validVParamValues = [27, 28];
                        ecSignatureVRS = signature_utils_1.signatureUtils.parseSignatureHexAsVRS(signature);
                        if (_.includes(validVParamValues, ecSignatureVRS.v)) {
                            isValidVRSSignature = ZeroEx.isValidSignature(orderHash, ecSignatureVRS, normalizedSignerAddress);
                        ...
                        if (_.includes(validVParamValues, ecSignatureRSV.v)) {
                            isValidRSVSignature = ZeroEx.isValidSignature(orderHash, ecSignatureRSV, normalizedSignerAddress);
