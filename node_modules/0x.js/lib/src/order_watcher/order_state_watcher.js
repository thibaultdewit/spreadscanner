...
var OrderStateWatcher = /** @class */ (function () {
    ...
    OrderStateWatcher.prototype.subscribe = function (callback) {
        ...
        if (!_.isUndefined(this._callbackIfExists)) {
            throw new Error(types_2.ZeroExError.SubscriptionAlreadyPresent);
        }
    ...
    OrderStateWatcher.prototype.unsubscribe = function () {
        if (_.isUndefined(this._callbackIfExists) || _.isUndefined(this._cleanupJobIntervalIdIfExists)) {
            throw new Error(types_2.ZeroExError.SubscriptionNotFound);
        }
    ...
    OrderStateWatcher.prototype._onOrderExpired = function (orderHash) {
        var orderState = {
            isValid: false,
            orderHash: orderHash,
            error: types_2.ExchangeContractErrs.OrderFillExpired,
        };
    ...
    OrderStateWatcher.prototype._onEventWatcherCallbackAsync = function (err, logIfExists) {
        return __awaiter(this, void 0, void 0, function () {
            var log, maybeDecodedLog, isLogDecoded, decodedLog, makerToken, makerAddress, _a, args, orderHashes, args, orderHashes, args, orderHashes, args, orderHashes, args, orderHash, isOrderWatched, args, orderHash, isOrderWatched;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!_.isNull(err)) {
                        ...
                        _a = decodedLog.event;
                        switch (_a) {
                            case token_1.TokenEvents.Approval: return [3 /*break*/, 1];
                            case token_1.TokenEvents.Transfer: return [3 /*break*/, 4];
                            case ether_token_1.EtherTokenEvents.Deposit: return [3 /*break*/, 7];
                            case ether_token_1.EtherTokenEvents.Withdrawal: return [3 /*break*/, 10];
                            case exchange_1.ExchangeEvents.LogFill: return [3 /*break*/, 13];
                            case exchange_1.ExchangeEvents.LogCancel: return [3 /*break*/, 16];
                            case exchange_1.ExchangeEvents.LogError: return [3 /*break*/, 19];
                        }
                        return [3 /*break*/, 20];
                    case 1:
