...
var EventWatcher = /** @class */ (function () {
    ...
    EventWatcher.prototype.subscribe = function (callback) {
        ...
        this._intervalIdIfExists = utils_1.intervalUtils.setAsyncExcludingInterval(this._pollForBlockchainEventsAsync.bind(this, callback), this._pollingIntervalMs, function (err) {
            _this.unsubscribe();
            callback(err);
        });
    };
