...
var ExpirationWatcher = /** @class */ (function () {
    function ExpirationWatcher(expirationMarginIfExistsMs, orderExpirationCheckingIntervalIfExistsMs) {
        ...
        var scoreFunction = function (orderHash) { return _this._expiration[orderHash].toNumber(); };
    ...
    ExpirationWatcher.prototype.subscribe = function (callback) {
        ...
        this._orderExpirationCheckingIntervalIdIfExists = utils_1.intervalUtils.setInterval(this._pruneExpiredOrders.bind(this, callback), this._orderExpirationCheckingIntervalMs, _.noop);
    };
    ...
    ExpirationWatcher.prototype._pruneExpiredOrders = function (callback) {
        ...
        while (true) {
            var hasTrakedOrders = this._orderHashByExpirationRBTree.size === 0;
            if (hasTrakedOrders) {
                break;
            }
