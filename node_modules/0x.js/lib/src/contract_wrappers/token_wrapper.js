...
var TokenWrapper = /** @class */ (function (_super) {
    ...
    TokenWrapper.prototype.subscribe = function (tokenAddress, eventName, indexFilterValues, callback) {
        ...
        var subscriptionToken = this._subscribe(normalizedTokenAddress, eventName, indexFilterValues, artifacts_1.artifacts.TokenArtifact.abi, callback);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._getLogsAsync(normalizedTokenAddress, eventName, blockRange, indexFilterValues, artifacts_1.artifacts.TokenArtifact.abi)];
                    case 1:
                        logs = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getContractAbiAndAddressFromArtifactsAsync(artifacts_1.artifacts.TokenArtifact, normalizedTokenAddress)];
                    case 1:
                        _a = _b.sent(), abi = _a[0], address = _a[1];
                        contractInstance = new token_1.TokenContract(this._web3Wrapper, abi, address);
