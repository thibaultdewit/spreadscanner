...
var ExchangeWrapper = /** @class */ (function (_super) {
    ...
    function ExchangeWrapper(web3Wrapper, networkId, abiDecoder, tokenWrapper, contractAddressIfExists, zrxContractAddressIfExists) {
        var _this = _super.call(this, web3Wrapper, networkId, abiDecoder) || this;
        _this._exchangeContractErrCodesToMsg = (_a = {},
            _a[types_2.ExchangeContractErrCodes.ERROR_FILL_EXPIRED] = types_2.ExchangeContractErrs.OrderFillExpired,
            _a[types_2.ExchangeContractErrCodes.ERROR_CANCEL_EXPIRED] = types_2.ExchangeContractErrs.OrderFillExpired,
            _a[types_2.ExchangeContractErrCodes.ERROR_FILL_NO_VALUE] = types_2.ExchangeContractErrs.OrderRemainingFillAmountZero,
            _a[types_2.ExchangeContractErrCodes.ERROR_CANCEL_NO_VALUE] = types_2.ExchangeContractErrs.OrderRemainingFillAmountZero,
            _a[types_2.ExchangeContractErrCodes.ERROR_FILL_TRUNCATION] = types_2.ExchangeContractErrs.OrderFillRoundingError,
            _a[types_2.ExchangeContractErrCodes.ERROR_FILL_BALANCE_ALLOWANCE] = types_2.ExchangeContractErrs.FillBalanceAllowanceError,
            _a);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        assert_1.assert.hasAtMostOneUniqueValue(takerTokenAddresses, types_2.ExchangeContractErrs.MultipleTakerTokensInFillUpToDisallowed);
                        exchangeContractAddresses = _.map(signedOrders, function (signedOrder) { return signedOrder.exchangeContractAddress; });
                        assert_1.assert.hasAtMostOneUniqueValue(exchangeContractAddresses, types_2.ExchangeContractErrs.BatchOrdersMustHaveSameExchangeAddress);
                        assert_1.assert.isValidBaseUnitAmount('fillTakerTokenAmount', fillTakerTokenAmount);
                        assert_1.assert.isBoolean('shouldThrowOnInsufficientBalanceOrAllowance', shouldThrowOnInsufficientBalanceOrAllowance);
                        return [4 /*yield*/, assert_1.assert.isSenderAddressAsync('takerAddress', takerAddress, this._web3Wrapper)];
                    case 1:
                    ...
                    case 5:
                        if (_.isEmpty(signedOrders)) {
                            throw new Error(types_2.ExchangeContractErrs.BatchOrdersMustHaveAtLeastOneItem);
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        assert_1.assert.hasAtMostOneUniqueValue(makers, types_2.ExchangeContractErrs.MultipleMakersInSingleCancelBatchDisallowed);
                        maker = makers[0];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getContractAbiAndAddressFromArtifactsAsync(artifacts_1.artifacts.ExchangeArtifact, this._contractAddressIfExists)];
                    case 1:
                        _a = _b.sent(), abi = _a[0], address = _a[1];
                        contractInstance = new exchange_1.ExchangeContract(this._web3Wrapper, abi, address);
