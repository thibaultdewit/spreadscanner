import { DecodedLogArgs, LogWithDecodedArgs, Order, SignedOrder } from '@0xproject/types';
...
export declare class ExchangeWrapper extends ContractWrapper {
    ...
    constructor(web3Wrapper: Web3Wrapper, networkId: number, abiDecoder: AbiDecoder, tokenWrapper: TokenWrapper, contractAddressIfExists?: string, zrxContractAddressIfExists?: string);
    /**
