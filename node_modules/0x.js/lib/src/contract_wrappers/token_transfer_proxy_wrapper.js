            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getContractAbiAndAddressFromArtifactsAsync(artifacts_1.artifacts.TokenTransferProxyArtifact, this._contractAddressIfExists)];
                    case 1:
                        _a = _b.sent(), abi = _a[0], address = _a[1];
                        contractInstance = new token_transfer_proxy_1.TokenTransferProxyContract(this._web3Wrapper, abi, address);
