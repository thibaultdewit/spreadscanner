...
var EtherTokenWrapper = /** @class */ (function (_super) {
    ...
    function EtherTokenWrapper(web3Wrapper, networkId, abiDecoder, tokenWrapper) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getLogsAsync(normalizedEtherTokenAddress, eventName, blockRange, indexFilterValues, artifacts_1.artifacts.EtherTokenArtifact.abi)];
                    case 1:
                        logs = _a.sent();
    ...
    EtherTokenWrapper.prototype.subscribe = function (etherTokenAddress, eventName, indexFilterValues, callback) {
        ...
        var subscriptionToken = this._subscribe(normalizedEtherTokenAddress, eventName, indexFilterValues, artifacts_1.artifacts.EtherTokenArtifact.abi, callback);
    ...
    EtherTokenWrapper.prototype.getContractAddressIfExists = function () {
        var networkSpecificArtifact = artifacts_1.artifacts.EtherTokenArtifact.networks[this._networkId];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getContractAbiAndAddressFromArtifactsAsync(artifacts_1.artifacts.EtherTokenArtifact, etherTokenAddress)];
                    case 1:
                        _a = _b.sent(), abi = _a[0], address = _a[1];
                        contractInstance = new ether_token_1.EtherTokenContract(this._web3Wrapper, abi, address);
