...
var CONTRACT_NAME_TO_NOT_FOUND_ERROR = {
    ZRX: types_2.ZeroExError.ZRXContractDoesNotExist,
    EtherToken: types_2.ZeroExError.EtherTokenContractDoesNotExist,
    Token: types_2.ZeroExError.TokenContractDoesNotExist,
    TokenRegistry: types_2.ZeroExError.TokenRegistryContractDoesNotExist,
    TokenTransferProxy: types_2.ZeroExError.TokenTransferProxyContractDoesNotExist,
    Exchange: types_2.ZeroExError.ExchangeContractDoesNotExist,
};
var ContractWrapper = /** @class */ (function () {
    ...
    ContractWrapper.prototype._tryToDecodeLogOrNoop = function (log) {
        if (_.isUndefined(this._abiDecoder)) {
            throw new Error(types_2.InternalZeroExError.NoAbiDecoder);
        }
                    ...
                    case 0:
                        if (_.isUndefined(addressIfExists)) {
                            if (_.isUndefined(artifact.networks[this._networkId])) {
                                throw new Error(types_2.ZeroExError.ContractNotDeployedOnNetwork);
                            }
    ...
    ContractWrapper.prototype._getContractAddress = function (artifact, addressIfExists) {
        if (_.isUndefined(addressIfExists)) {
            ...
            if (_.isUndefined(contractAddress)) {
                throw new Error(types_2.ZeroExError.ExchangeContractDoesNotExist);
            }
